...
public class NetworkSMSHandler implements MessageProcessor {
	 ...
	 * 
	 * @param state
	 *            The State to which to set the WiFI. "ON" puts the WiFI on,
	 ...
	 * 
	 * @param SSID
	 *            SSID of the network to which to connect
	 * @param password
	 *            The password of the network to which to connect
	 * @return Boolean representing whether or not the operation was successful
	 */
	 ...
	 * 
	 * @param state
	 *            The state to which to set the bluetooth. "ON" sets it on,
	 ...
	 * 
	 * @param deviceName
	 *            The name of the bluetooth device to which tio connect
	 * @return Boolean representing whether or not the operation was successful
	 */
