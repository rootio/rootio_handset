...
public class Artist {
	...
	/**
	 * Constructor for when the name of the artist is known as well as the country of the artist
	 * @param name The name of the artist
	 ...
	 * @param name The name of the artist
	 * @param country The country of the artist
	 * @param wiki The URL to a wiki with information for this artist
	 */
