...
public class EpisodeManager {
	 ...
	 * 
	 * @param programId
	 *            The ID of the Program with which this episode is associated
	 * @param eventtimeid
	 *            The ID of the event time with which this program is associated
	 * @param episodeNumber
	 *            The serial number of this episode
	 */
