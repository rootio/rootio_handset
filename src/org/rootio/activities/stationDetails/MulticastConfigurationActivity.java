...
public class MulticastConfigurationActivity extends Activity implements DialogInterface.OnClickListener, Runnable {
	...
	/**
	 * Handles the click for the cancel button, effectively finishing the
	 * activity
	 * 
	 * @param v
	...
	/**
	 * Saves the multicast configuration of the group to join to receive
	 * streaming server announcements.
	 * 
	 * @param serverAddress
	 *            The address of the broadcast group to join to receive
	...
	/**
	 * Validates supplied IP address for conformity to broadcast address
	 * specifications
	 * 
	 * @param inetAddress
	 *            the supplied Address for the broadcast group
	 * @return Boolean indicating whether address conforms to broadcast
	 *         specifications. True: conforms, False: does not conform
	 */
