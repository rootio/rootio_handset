...
public class BlackListActivity extends Activity {
	 ...
	 * 
	 * @param v
	 *            The view (uncheck all button) that was selected
	 */
	...
	/**
	 * Handles the click for the button to remove a given number from the
	 * blacklist
	 * 
	 * @param v
	 *            The view (remove button) that was clicked
	 */
	 ...
	 * 
	 * @param msisdn
	 *            The MSISDN to be removed from the blacklist
