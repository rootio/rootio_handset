...
public class SynchronizationConfiguration {
	 ...
	 * 
	 * @param configuration
	 *            An array of String arrays containing the configuration as
	 ...
	 * 
	 * @return An array of String Arrays each being a representation of a record
	 *         in the database
	 */
	...
	/**
	 * Gets whether or not synchronizations should be limited to a given time
	 * frame
	 * 
	 * @return Boolean of whether synchronizations are limited to a given time
	 *         or not. True: limited, False: not limited
	 */
	 ...
	 * 
	 * @return String representation of the start time of the Sync window in
	 *         HH:mm:ss format
	 */
	 ...
	 * 
	 * @return String representation of the end time of the Sync window in
	 *         HH:mm:ss format
	 */
	 ...
	 * 
	 * @return Integer representing the ID of the unit used to define the
	...
	/**
	 * Gets the quantity of time in specified units at which to do the
	 * synchronization
	 * 
	 ...
	 * 
	 * @param syncDuringParticularTimes
	 *            Boolean specifying whether to sync during particular time
	 ...
	 * 
	 * @param syncStartTime
	 *            String representation of the Synchronization start time in the
	 *            format HH:mm:ss
	 */
	 ...
	 * 
	 * @param syncEndTime
	 *            String representation of the Synchronization end time in the
	 *            format HH:mm:ss
	 */
	...
	/**
	 * Sets the ID of the unit used to measure the duration of the
	 * synchronization intervals
	 * 
	 * @param unitId
	 *            Integer ID of the unit used to measure the time interval
	...
	/**
	 * Sets the quantity of the time units specifying the interval between
	 * synchronizations
	 * 
	 * @param quantity
	 *            Integer representation of the number of time units between
	 *            synchronizations
	 */
	 ...
	 * 
	 * @return integer number of the rows affected by this transaction in the
	 *         database
	 */
	public int save() {
		String tableName = "frequencyconfiguration";
