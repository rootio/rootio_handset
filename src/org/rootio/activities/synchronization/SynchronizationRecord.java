...
public class SynchronizationRecord {
	...
	SynchronizationRecord(String id, String synchronizationDateString, String HTTPResponseCodeString, String changeCountString)
	{
		...
		this.synchronizationDate = Utils.getDateFromString(synchronizationDateString, "yuyyy-MM-dd HH:mm:ss");
		this.id = Utils.parseIntFromString(id);
	}

	/**
	 * Gets the HTTP response code that the request for this synchronization received from the server
	 * @return Integer representing HTTP response code received from cloud server
	 */
	...
	/**
	 * Gets the number of changes that are involved in this particular synchronization
	 * @return Integer representing the number of changes in this synchronization
	 */
	int getChangeCount()
	{
	 ...
	 * @return Date object representing date when this record was written in the database
	 */
