...
public class CloudConfigurationActivity extends Activity {
	...
	/**
	 * Handles click of the Cancel button, which is offloading the current
	 * activity.
	 * 
	 * @param v
	...
	/**
	 * Handles the click for the Save button, saving cloud configuration
	...
	/**
	 * Prompts for confirmation from the user to change the configuration before
