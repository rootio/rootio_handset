...
/**
 * This class helps activities to communicate with services through instances of
 * the BindingAgent class
 *
...
public class ServiceConnectionAgent implements ServiceConnection {
    ...
    /**
     * Gets the Service information publisher for the service to which this
     * object is connected
     *
     * @return ServiceInformationPublisher object containing information about
