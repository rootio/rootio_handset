...
public class CallLogHandler implements SynchronizationHandler {
    ...
    public String getSynchronizationURL() {
        return String.format("%s://%s:%s/%s/%s/call?api_key=%s&version=%s_%s", this.cloud.getServerScheme(), this.cloud.getServerAddress(), this.cloud.getHTTPPort(), "api/station", this.cloud.getStationId(), this.cloud.getServerKey(), BuildConfig.VERSION_NAME, BuildConfig.VERSION_CODE);
    }
}
